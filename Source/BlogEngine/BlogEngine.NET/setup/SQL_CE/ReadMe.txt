...
to get started with BlogEngine.NET.  Although not needed, SQL_CE_Setup_2.6.sql is provided
...
There is an upgrade script to update your SDF file so it is compliant with BlogEngine.NET 2.6.
...
Additionally, the web.config file has changed from 2.5 to 2.6.  It will likely be easiest to start
