...
<div data-role="header">
  ...
  <div data-role="navbar" data-iconpos="top">
	  <ul>
      <li><a href="<%=Utils.RelativeWebRoot%>archive.aspx" data-icon="grid" data-transition="slide"><%= Resources.labels.archive %></a></li>
		  <li><a href="<%=Utils.RelativeWebRoot%>contact.aspx" id="contact" data-icon="custom" data-transition="slide" data-ajax="false"><%= Resources.labels.contact %></a></li>
		  <li><a href="<%=Utils.RelativeWebRoot%>search.aspx" data-icon="search" data-transition="slide"><%= Resources.labels.search %></a></li>
